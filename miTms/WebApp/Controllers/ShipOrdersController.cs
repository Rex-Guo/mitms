...
namespace WebApp.Controllers
{
    ...
    public class ShipOrdersController : Controller
    {
       ...
       .SelectPageAsync(page, rows, out totalCount);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CreateShipOrder(ShipOrder shiporder) {
            try
            {
                this.shipOrderService.Create(shiporder);
        ...
        public ActionResult GetShipOrderNo() {
            ...
            return Json( DbSequence.GetNextShipOrderNo(),JsonRequestBehavior.AllowGet);
        }
        //导出Excel
        [HttpPost]
